...
**Unit testing** is a personal project where I implement knowledge acquired from the unit test lesson.
...
- **index.js:** This project has an index.js file which contains all functions to be tested
- **test.js:** This project also has a test.js file that all tests run on the functions in the index.js file.
...
<ol>
    ...
    <li>Run the command "git clone git@github.com:Adams-Ghub/unit-testing.git" in the terminal or command line</li>
...
I would like to acknowledge and thank jest for their library. It really makes unit testing easy.
